...
module.exports = function(source) {
    ...
    const ast = babylon.parse(source, { sourceType: 'module', plugins: ['jsx', 'asyncGenerators', 'classProperties', "decorators-legacy", 'exportNamespaceFrom']});
    traverse(ast, {
...
var expressionVisitor = {
    ...
    AwaitExpression: function(path) {
        ...
        const targetPath = path.find(path => t.isExpressionStatement(path.node));
        targetPath.replaceWith(ast);
    }
};